...
const newYorkBusinesses = businesses.filter(business => {
  ...
  const nyBusDOM = document.querySelector("nyBusinesses")
  nyBusDOM.innerHTML = "<h2>New York Businesses</h2>"

  const nyComponent = (businesses) => {
      businesses.forEach(businesses => {
          nyBusDOM.innerHTML += `
          <h3>${businesses.comapnyName}</h3>
          <section>
            ...
            nyBusDOM.innerHTML += "<hr>"
      })
  }
        nyComponent(newYorkBusinesses)
